...
import { date } from '../SendMessageForm/SendMessageForm'
...
const MessageList = () => {
    ...
    localStorage.setItem('fullYear', fullYear)
    localStorage.setItem('fullDate', fullDate)
    localStorage.setItem('fullMonth', fullMonth)
    localStorage.setItem('fullHours', fullHours)
    ...
    const asd = timeZone.includes(localStorage.getItem('fullYear') && localStorage.getItem('fullDate') && localStorage.getItem('fullMonth') && localStorage.getItem('fullHours')) ? 'СЕГОДНЯ' : getDayOfTheWeek()
    ...
    return (
        <div className='MessageList' ref={myRef}>
            <div 
                ...
                <div className='MessageList__date'>{asd}</div>
                    {messages.map((item, i) => {
