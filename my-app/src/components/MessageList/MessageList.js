            ...
            <div className='MessageList__wrapper'>
                <div className='MessageList__get_message'>Get message</div>
                    {messages.map((item, i) => {
                        if (item) {
                            return (
                                <div className='MessageList__set_message'>
                                  <div className='MessageList__set_message_wrapper'>
                                        <div key={i} className='MessageList__set_message_text'>{item.message}</div> 
                                        <div className='MessageList__set_message_container-time'> 
                                            <div className='MessageList__set_message_time'>{`${hours}:${minutes}`}</div>
                                            <div className='MessageList__set_message_picture'>
                        ...
                        // if (item) {
                        //     return <div key={i} className='MessageList__set-message'>{item.message}</div>    
                        // } else {
                        //     return null
                        // }
                    })}
